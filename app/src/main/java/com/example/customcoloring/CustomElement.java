...
public abstract class CustomElement {
	...
	protected Paint myPaint = new Paint(Paint.ANTI_ALIAS_FLAG);

	/** this color is used to draw outlines around a shape */
	protected Paint outlinePaint = new Paint(Paint.ANTI_ALIAS_FLAG);

	/** this paint is used to draw highlights */
	protected Paint highlightPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
